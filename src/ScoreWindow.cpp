...
ScoreWindow::ScoreWindow(float width, float height) {
  ...
  score[0].setPosition( sf::Vector2f(width/2.0 - 4*textRect.width/2.0 - 4, height/2.0 - 2*textRect.height) );
  ...
  score[1].setPosition( sf::Vector2f(width/2.0 + 2*textRect.width/2.0 + 4, height/2.0 - 2*textRect.height) );
}
